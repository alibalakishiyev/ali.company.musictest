...
import com.ali.musictetsbyali.QuesitionsItem;
import com.ali.musictetsbyali.R;
import com.ali.musictetsbyali.ResultActivity;
...
public class MuslumMaq extends AppCompatActivity {
        ...
        aans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentQuestions < quesitionsItems.size() - 1) {
                    ...
                    Intent intent = new Intent(MuslumMaq.this, ResultActivity.class);
    ...
    private void showInterstitialAd() {
        if (mInterstitialAd != null) {
            mInterstitialAd.show(MuslumMaq.this);
    ...
    private void loadAllQuestions() {
        ...
        addQuestionsFromJsonArray("muslummaqo1");
        addQuestionsFromJsonArray("muslummaqo2");
        addQuestionsFromJsonArray("muslummaqo3");
        addQuestionsFromJsonArray("muslummaqo4");
        addQuestionsFromJsonArray("muslummaqo5");

    }

    private void addQuestionsFromJsonArray(String arrayName) {
        String jsonquiz = loadJsonFromAsset("MuslumMaqo.json");
        try {
    ...
    OnBackPressedCallback callback = new OnBackPressedCallback(true) {
        ...
        public void handleOnBackPressed() {
            MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(MuslumMaq.this);
            ...
            materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int i) {
                    startActivity(new Intent(MuslumMaq.this, musiqiad.class));
                    finish();
